        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2 lg:gap-7">
          {AI_PRODUCT_CATEGORIES.map((category, index) => (
            <motion.article
              ...
              className="group relative flex min-h-[480px] flex-col overflow-hidden rounded-2xl border border-[rgba(212,175,55,0.2)] bg-[#111111] p-5 shadow-[0_30px_100px_rgba(0,0,0,0.4),0_0_40px_rgba(212,175,55,0.05)] transition-all duration-500 hover:border-[rgba(212,175,55,0.5)] hover:shadow-[0_36px_120px_rgba(212,175,55,0.16)] sm:p-6"
            >
              <div
