...
| Website Builder (product) | **In Progress** (Phase 1) | Create → **static visual preview** → NL Improve → linked versions in `projects` + ZIP export; compiled Live Preview still off (D-004). See `WEBSITE_BUILDER_PHASE1_REPORT.md` |
...
- **L05:** Advisory dashboard bundle budgets (`npm run perf:budget`).  
