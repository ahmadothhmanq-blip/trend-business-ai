...
import { executeWebsiteReviewRollback } from "@/lib/website/platform/services/review-service";
...
/**
 * POST — Rollback to a previous Review Studio version.
 */
export async function POST(request: Request, { params }: Params) {
  ...
  const result = await executeWebsiteReviewRollback({
