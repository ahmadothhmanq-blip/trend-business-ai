...
export async function GET(_request: Request, context: RouteContext) {
  ...
  if (error || !data) return apiNotFoundError(API_ERROR_CODES.NOT_FOUND, "Logo not found");
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  if (sourceError || !source) return apiNotFoundError(API_ERROR_CODES.NOT_FOUND, "Logo not found");
