...
export async function DELETE(_request: Request, context: RouteContext) {
  ...
  if (error || !data) return apiNotFoundError(API_ERROR_CODES.NOT_FOUND, "Webhook not found");
...
export async function PATCH(_request: Request, context: RouteContext) {
  ...
  if (!existing) return apiNotFoundError(API_ERROR_CODES.NOT_FOUND, "Webhook not found");
