...
export const THEME_PAGE_ARCHITECTURES: ThemePageArchitecture[] = [
  ...
  arch({
    ...
    pageTopology: "card-first-masonry",
    sectionShellVariant: "bento",
    description: "Refined nav · split hero · product showcase · global SaaS pricing",
    animationLanguage: "subtle fade · soft elevation",
    responsiveBehavior: "bento grid · floating demo CTA · enterprise rhythm",
    floatingCta: true,
  }),
