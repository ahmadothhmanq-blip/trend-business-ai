...
export const P_R_O_D_U_C_T_D_E_T_A_I_L_S_VARIANTS = {
  default: {
...
export const P_R_O_D_U_C_T_D_E_T_A_I_L_S_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
