...
export const C_H_E_C_K_O_U_T_S_U_M_M_A_R_Y_VARIANTS = {
  default: {
...
export const C_H_E_C_K_O_U_T_S_U_M_M_A_R_Y_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
