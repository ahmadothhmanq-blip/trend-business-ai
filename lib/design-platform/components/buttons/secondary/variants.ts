...
export const S_E_C_O_N_D_A_R_Y_B_U_T_T_O_N_VARIANTS = {
  default: {
...
export const S_E_C_O_N_D_A_R_Y_B_U_T_T_O_N_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
