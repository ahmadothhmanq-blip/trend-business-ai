...
export const F_L_O_A_T_I_N_G_B_U_T_T_O_N_VARIANTS = {
  default: {
...
export const F_L_O_A_T_I_N_G_B_U_T_T_O_N_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
