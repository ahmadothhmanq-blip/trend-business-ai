...
export const T_E_S_T_I_M_O_N_I_A_L_C_A_R_D_VARIANTS = {
  default: {
...
export const T_E_S_T_I_M_O_N_I_A_L_C_A_R_D_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
