...
export const C_O_M_P_A_R_I_S_O_N_T_A_B_L_E_VARIANTS = {
  default: {
...
export const C_O_M_P_A_R_I_S_O_N_T_A_B_L_E_SIZES: Record<TbdpComponentSize, { padding: string; fontSize: string }> = {
