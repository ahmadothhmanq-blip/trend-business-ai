...
const INDUSTRY_VISUALS: Record<IndustryId, Record<SectionKey, string[]>> = {
  ...
  gaming: {
    hero: ["Esports arena cinematic hero", "Game character action wide shot"],
    about: ["Game studio team at work", "Developer culture behind the scenes"],
    services: ["Esports tournament broadcast", "Community event livestream"],
    features: ["Gameplay feature highlight", "Multiplayer squad action scene"],
    team: ["Game dev team portrait", "Esports roster team photo"],
    gallery: ["In-game screenshot gallery", "Concept art showcase wall"],
    portfolio: ["Released game title showcase", "Franchise milestone poster"],
    testimonials: ["Pro gamer portrait", "Streamer testimonial setup"],
    pricing: ["Neon gaming atmosphere blur", "Controller and headset flat-lay"],
    faq: ["RGB lighting abstract blur", "Digital grid texture atmosphere"],
    contact: ["Esports booth welcome", "Community manager meet-and-greet"],
    blog: ["Game patch notes editorial", "Dev diary behind-the-scenes"],
    cta: ["Play now wide cinematic shot", "Join beta motivating scene"],
    footer: ["Dark neon gaming atmosphere blur"],
  },
  technology: {
