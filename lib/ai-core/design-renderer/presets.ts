...
> = {
  ...
  law: {
    ...
    visualStyle: {
      layoutStyle: "legal-trust",
      density: "airy",
      heroTreatment: "Dark luxury legal hero with consultation CTA",
      cardTreatment: "Refined practice area and attorney cards",
      ctaTreatment: "Book consultation primary CTA",
      motionNotes: "Restrained cinematic reveals",
      uiPatterns: [
        "luxury legal hero",
        "practice area grid",
        "attorney profiles",
    ...
    homeSections: [
      { name: "Hero", componentId: "HeroLuxury", assetRole: "hero" },
      { name: "Practice areas", componentId: "ServicesModern", assetRole: "service" },
      { name: "Attorneys", componentId: "TeamSection", assetRole: "section" },
      { name: "Cases", componentId: "CaseStudies", assetRole: "section" },
      { name: "Consultation", componentId: "BookingForm" },
      { name: "Contact", componentId: "ContactCta" },
    ],
    layoutRules: [
      "Authority-first: practice areas before attorney bios",
      "Case proof before final consultation CTA",
    ],
  },
  blog: {
    industryId: "blog",
    ...
    visualStyle: {
      layoutStyle: "editorial-blog",
      density: "balanced",
      heroTreatment: "Editorial hero with featured article",
      cardTreatment: "Article cards with category chips",
      ctaTreatment: "Subscribe primary CTA",
      motionNotes: "Soft editorial fade",
      uiPatterns: [
        "editorial hero",
        "article grid",
        "category highlights",
    ...
    homeSections: [
      { name: "Hero", componentId: "HeroSplit", assetRole: "hero" },
      { name: "Featured articles", componentId: "BlogSection", assetRole: "section" },
      { name: "Categories", componentId: "FeatureHighlights", assetRole: "section" },
      { name: "Author", componentId: "TeamSection", assetRole: "section" },
      { name: "Newsletter", componentId: "CtaSplit" },
      { name: "Contact", componentId: "ContactCta" },
    ],
    layoutRules: [
      "Featured articles before category browse",
      "Newsletter CTA after latest posts",
    ],
  },
  "landing-page": {
    ...
    visualStyle: {
      layoutStyle: "conversion-landing",
      density: "balanced",
      heroTreatment: "Product hero with single primary CTA",
      cardTreatment: "Benefit and feature cards with metrics",
      ctaTreatment: "Sticky Get started CTA",
      motionNotes: "Crisp conversion motion",
      uiPatterns: [
        "product hero",
        "benefit highlights",
        "feature grid",
    ...
    homeSections: [
      { name: "Hero", componentId: "HeroProduct", assetRole: "hero" },
      { name: "Benefits", componentId: "FeatureHighlights", assetRole: "section" },
      { name: "Features", componentId: "FeaturesModern", assetRole: "product" },
      { name: "Statistics", componentId: "BrandTrust", assetRole: "section" },
      { name: "Pricing", componentId: "PricingModern" },
      { name: "FAQ", componentId: "FaqAccordion" },
      { name: "CTA", componentId: "CtaBand" },
    ],
    layoutRules: [
      "Single-page flow: benefits → features → proof → pricing → CTA",
      "Minimize navigation distractions; repeat primary CTA",
    ],
  },
  ecommerce: {
