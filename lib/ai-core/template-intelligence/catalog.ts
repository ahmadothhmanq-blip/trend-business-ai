...
const CORE_AUTO_CORPORATE = comps(
  "SiteHeader",
  "HeroSplit",
  "ServicesModern",
  "VehicleComparison",
...
const CORE_AUTO_TECHNOLOGY = comps(
  "NavModern",
  "HeroInteractive",
  "FeaturesBento",
  "TimelineSection",
...
const CORE_MEDICAL = PALETTE_MEDICAL;
const CORE_LAW = PALETTE_LAW;
const CORE_EDUCATION = PALETTE_EDUCATION;
const CORE_BLOG = PALETTE_BLOG;
const CORE_LANDING = PALETTE_LANDING;
...
export const TEMPLATE_INTELLIGENCE_CATALOG: TemplateIntelligenceDefinition[] = [
  ...
  },
  {
    ...
    category: "Automotive",
    industry: "automotive",
    designStyle: "Luxury showroom editorial",
    designPreset: "luxury",
    layoutStructure: "vehicle-showroom",
    colors: {
      primary: "#0B0B0F",
    ...
    components: CORE_AUTO_LUXURY,
    animations: cinematic,
    brandPresetId: "luxury-brand",
    premiumTemplateId: "automotive",
    keywords: ["automotive", "luxury", "showroom", "concierge", "heritage"],
    audienceHints: ["luxury buyer", "collector", "enthusiast"],
    brandStyleHints: ["luxury", "automotive", "premium"],
  },
  {
    ...
    category: "Automotive",
    industry: "automotive",
    designStyle: "Corporate automotive trust",
    designPreset: "corporate",
    layoutStructure: "corporate-trust",
    colors: {
      primary: "#0F172A",
    ...
    components: CORE_AUTO_CORPORATE,
    animations: crisp,
    brandPresetId: "corporate-brand",
    premiumTemplateId: "automotive",
    keywords: ["automotive", "corporate", "dealer", "financing", "fleet"],
    audienceHints: ["fleet buyer", "family", "professional"],
    brandStyleHints: ["corporate", "trust", "automotive"],
  },
  {
    ...
    category: "Automotive",
    industry: "automotive",
    designStyle: "Modern product-led dealership",
    designPreset: "modern",
    ...
    components: CORE_AUTO_MODERN,
    animations: crisp,
    brandPresetId: "minimal-brand",
    premiumTemplateId: "automotive",
    keywords: ["automotive", "modern", "inventory", "ev", "test drive"],
    audienceHints: ["millennial buyer", "ev shopper", "first-time buyer"],
    brandStyleHints: ["modern", "product", "automotive"],
  },
  {
    ...
    category: "Automotive",
    industry: "automotive",
    designStyle: "Futuristic connected mobility",
    designPreset: "tech",
    layoutStructure: "product-saas",
    colors: {
      primary: "#020617",
    ...
    components: CORE_AUTO_TECHNOLOGY,
    animations: crisp,
    brandPresetId: "technology-brand",
    premiumTemplateId: "automotive",
    keywords: ["automotive", "technology", "ev", "connected", "ai", "autonomous"],
    audienceHints: ["tech buyer", "early adopter", "ev enthusiast"],
    brandStyleHints: ["technology", "futuristic", "automotive"],
  },
  {
  ...
  },
  {
    ...
    components: CORE_MEDICAL,
    animations: fadeUp,
    brandPresetId: "corporate-brand",
    premiumTemplateId: "healthcare",
    keywords: ["medical", "clinic", "hospital", "doctor", "healthcare", "dental"],
    audienceHints: ["patients", "families", "caregivers"],
    brandStyleHints: ["healthcare", "medical", "clinical"],
  },
  {
    id: "ti-law-firm",
    name: "Law Firm",
    ...
    animations: cinematic,
    brandPresetId: "luxury-brand",
    premiumTemplateId: "law",
    keywords: ["law", "lawyer", "attorney", "legal", "law firm"],
    audienceHints: ["clients", "businesses", "individuals"],
    brandStyleHints: ["legal", "law firm", "attorney"],
  },
  {
    ...
    components: CORE_EDUCATION,
    animations: fadeUp,
    brandPresetId: "corporate-brand",
    premiumTemplateId: "education",
    keywords: ["education", "school", "university", "academy", "bootcamp"],
    audienceHints: ["students", "parents", "professionals"],
    brandStyleHints: ["education", "campus", "learning"],
  },
  {
    ...
    components: CORE_BLOG,
    animations: fadeUp,
    brandPresetId: "creative-brand",
    premiumTemplateId: "blog",
    keywords: ["blog", "article", "news", "magazine", "editorial"],
    audienceHints: ["readers", "subscribers", "professionals"],
    brandStyleHints: ["blog", "editorial", "publishing"],
  },
  {
    ...
    components: CORE_LANDING,
    animations: crisp,
    brandPresetId: "premium-saas-brand",
    premiumTemplateId: "landing-page",
    keywords: ["landing page", "startup", "saas", "launch", "marketing"],
